          ...
          <div className="flex w-full items-center justify-between px-4">
            <div>
              ...
              <nav
                ...
                id="navbarCollapse"
                className={`absolute right-4 top-full w-full max-w-[250px] rounded-lg text-white px-6 py-1 shadow-lg bg-blue lg:bg-transparent dark:bg-dark-2 lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none lg:dark:bg-transparent ${!open && "hidden"
                  } `}
              >
